...
model.fit(train_gen,
        steps_per_epoch=49, #NUMBER OF SAMPLES IN TRAINING/BATCH_SIZE : https://datascience.stackexchange.com/questions/47405/what-to-set-in-steps-per-epoch-in-keras-fit-generator
        epochs=10, 
...
model.save('saved_models/augmented_data_cnn_10layer_224_224') 
model.save_weights('saved_models/augmented_data_cnn_10layer_224_224/weights') 
